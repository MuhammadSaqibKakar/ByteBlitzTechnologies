...
export function AdminPanel({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="modal-fade fixed inset-0 z-[80] flex items-center justify-center bg-[#071B3A]/70 px-4 py-6">
      <div className="modal-panel-pop max-h-[88vh] w-full max-w-3xl overflow-y-auto rounded-lg bg-white shadow-2xl">
